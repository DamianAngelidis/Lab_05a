...
function multiply(a, b) { //eslint-disable-line
  var multipleSum = a * b;
  var answer = 'The product of ' + a + ' and ' + b + ' is ' + multipleSum + '.';
 
  return [multipleSum, answer]
}
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
  ...
  for(var i =0; i < dynamicArray.length; i++) {
    multipleAll = parseInt(multiply(multipleAll,dynamicArray[i])[0]);
  }
  var fullSentence = 'The numbers ' + dynamicArray + ' have a product of ' + multipleAll + '.';
